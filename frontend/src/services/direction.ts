import API from './api'
import UniversityDirections from './dto/university-directions'
import DirectionWithRatingDTO from './dto/direction-with-rating'

export default class Direction extends API {
    ...
    getForUserWithRating = async () => {
        ...
        return data.map((u: any) => new UniversityDirections(
